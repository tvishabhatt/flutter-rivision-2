...
class CategoryPageHttp extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return CategoryPageHttpState();
  }

}
class CategoryPageHttpState extends State<CategoryPageHttp>{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: APIHelper_http.apiHelper_http.featchAllNews(),
